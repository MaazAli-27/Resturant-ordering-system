          ...
          <>
            ...
            <div className="order-info-card">
              <div className="order-info-row">
                ...
                <span className="info-value accent">#{order._id.slice(-6).toUpperCase()}</span>
              </div>
              <div className="order-info-row">
              ...
              <div className="order-info-row">
                ...
                <span className="info-value accent">${order.totalAmount.toFixed(2)}</span>
              </div>
              {order.tableNumber && (
                <div className="order-info-row">
                  ...
                  {STEPS.map((step, i) => {
                    ...
                    return (
                      <div key={step.key} className="step-3d-item">
                        ...
                        {/* Step bubble */}
                        <div
                          className={`step-bubble-3d ${isDone ? 'done' : ''} ${isActive ? 'active' : ''} ${isFuture ? 'future' : ''}`}
            ...
            <div className="items-card-3d">
              ...
              {order.items.map((item, i) => (
                <div key={i} className="ordered-item-3d">
                  <span className="item-name-3d">{item.name} <span className="item-qty">×{item.quantity}</span></span>
